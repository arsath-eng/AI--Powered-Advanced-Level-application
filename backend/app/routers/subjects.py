...
def update_subject(item_id: uuid.UUID, subject: schemas.SubjectBase, db: Session = Depends(auth.get_db)):
...
def delete_subject(item_id: uuid.UUID, db: Session = Depends(auth.get_db)):
